...
#define STRING_CONFIG_H_AUTHOR "Micah Friesen" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 pro ready"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.3, 100.3, 400, 93 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -23.6, -6.5, -2.6  }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 2000   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE    300   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
